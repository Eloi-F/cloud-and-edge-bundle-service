from car.models import RequestSet, ConstraintValues, OdrlRequest
from pathlib import Path

from car.parser import parse_set
...
def build_request_payload(request: OdrlRequest) -> RequestSet:
    """
